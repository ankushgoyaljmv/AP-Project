...
//        this.warehouse.getItems().get(1).setName("Test@Item2");
        ...
        this.subCB.getSelectionModel().selectedItemProperty().addListener(  (e,oldvalue,newvalue) -> {
            ...
            if(index >= 0 && index1>=0){
                ...
                for (int i = 0; i < this.warehouse.getCategories().get(index).getSubcategories().get(index1).getItems().size(); i++) {
                    this.itemCB.getItems().add(this.warehouse.getCategories().get(index).getSubcategories().get(index1).getItems().get(i).getName());
                }
            }
    ...
    public void delItem(){
        ...
        itemTemp.setName(this.warehouse.getCategories().get(index).getSubcategories().get(index1).getItems().get(indexT).getName());
...
//        System.out.println("index of item:- " + this.nameTF.getText().trim() + "-- " + index2);
    ...
    public void delSub(){
        ...
        this.warehouse.deleteSub_Category(index, index1);
