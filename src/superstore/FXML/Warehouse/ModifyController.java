 ...
 * Roll No : - 2017304
 */
package superstore.FXML.Warehouse;
...
//            reset();
            ...
            switch(this.type){
                case 0:
                    ...
                    if(index>=0){
                        String s = this.warehouse.getCategories().get(index).getName();
                        this.TF.setText(s);
                        this.addcommon.setDisable(false);
                    }
                    break;
...
//            reset();
            ...
            switch(this.type){
                ...
                case 1:
                    ...
                    if(index>=0){
                        String s = this.warehouse.getCategories().get(in).getSubcategories().get(index).getName();
                        this.TF.setText(s);
                        this.addcommon.setDisable(false);
                    }
                ...
                case 2:
                    ...
                    if(index>=0){
                        ...
                        for (int i = 0; i < this.warehouse.getCategories().get(in).getSubcategories().get(index).getItems().size(); i++) {
                            this.itemCB.getItems().add(this.warehouse.getCategories().get(in).getSubcategories().get(index).getItems().get(i).getName());                                    
                        }
...
//            reset();
            ...
            switch(this.type){
                ...
                case 2:
                    ...
                    if(index1>=0){
                        String s = this.warehouse.getCategories().get(in).getSubcategories().get(index).getItems().get(index1).getName();
                        this.TF.setText(s);
                        this.addcommon.setDisable(false);
                        
                        
                        Item temp = this.warehouse.getCategories().get(in).getSubcategories().get(index).getItems().get(index1);
    ...
    public void add1(){
        ...
        switch(this.type){
            case 0:
                ...
                old = this.warehouse.getCategories().get(ind).getName();
                
                if(s.equalsIgnoreCase(old)){
                    System.out.println("SAME THING, NO CHANGE");
                }
                else{
                    for (int i = 0; i < this.warehouse.getCategories().get(ind).getSubcategories().size(); i++) {
                        for (int j = 0; j < this.warehouse.getCategories().get(ind).getSubcategories().get(i).getItems().size(); j++) {
                            String oldpath = this.warehouse.getCategories().get(ind).getSubcategories().get(i).getItems().get(j).getPath();
                            String[] t = oldpath.split(">");
                            String newpath = s+">"+t[1];
                            Item temp = new Item();
                            temp.setName(this.warehouse.getCategories().get(ind).getSubcategories().get(i).getItems().get(j).getName());
                            int in = this.warehouse.getItems().indexOf(temp);
                            this.warehouse.getCategories().get(ind).getSubcategories().get(i).getItems().get(j).setPath(newpath);
                            this.warehouse.getItems().get(in).setPath(newpath);
                        }
                    }
                }
                ...
                this.warehouse.getCategories().get(ind).setName(s);
            ...
            case 1:
                ...
                old = this.warehouse.getCategories().get(ind).getSubcategories().get(ind1).getName();
                
                if(s.equalsIgnoreCase(old)){
                    System.out.println("SAME THING, NO CHANGE");
                }
                else{
                    for (int j = 0; j < this.warehouse.getCategories().get(ind).getSubcategories().get(ind1).getItems().size(); j++) {
                            String oldpath = this.warehouse.getCategories().get(ind).getSubcategories().get(ind1).getItems().get(j).getPath();
                            String[] t = oldpath.split(">");
                            String newpath = s+">"+t[1];
                            Item temp = new Item();
                            temp.setName(this.warehouse.getCategories().get(ind).getSubcategories().get(ind1).getItems().get(j).getName());
                            int in = this.warehouse.getItems().indexOf(temp);
                            this.warehouse.getCategories().get(ind).getSubcategories().get(ind1).getItems().get(j).setPath(newpath);
                            this.warehouse.getItems().get(in).setPath(newpath);
                    }
                ...
                this.warehouse.getCategories().get(ind).getSubcategories().get(ind1).setName(s);
    ...
    public void clickOnAdd(){
        ...
        if(index2>=0){
            ...
            itemTemp.setName(this.warehouse.getCategories().get(index).getSubcategories().get(index1).getItems().get(index2).getName());
            int in = this.warehouse.getItems().indexOf(itemTemp);
            ...
            //in cat>sub>item
            this.warehouse.getCategories().get(index).getSubcategories().get(index1).getItems().get(index2).setName(name);
            this.warehouse.getCategories().get(index).getSubcategories().get(index1).getItems().get(index2).setPrice(price);
            this.warehouse.getCategories().get(index).getSubcategories().get(index1).getItems().get(index2).setQuantity(quantity);
            this.warehouse.getCategories().get(index).getSubcategories().get(index1).getItems().get(index2).setH(h);
            this.warehouse.getCategories().get(index).getSubcategories().get(index1).getItems().get(index2).setK(k);

            //in item
            this.warehouse.getItems().get(in).setName(name);
            this.warehouse.getItems().get(in).setPrice(price);
            this.warehouse.getItems().get(in).setQuantity(quantity);
            this.warehouse.getItems().get(in).setH(h);
            this.warehouse.getItems().get(in).setK(k);
